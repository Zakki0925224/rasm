...
fn main() {
    ...
    let obj3 = [
        ...
        0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x74, 0x65, 0x73, 0x74, 0x2f, 0x6d, 0x69, 0x6e, 0x2e,
        0x6e, 0x61, 0x73, 0x6d, 0x0, 0x5f, 0x73, 0x74, 0x61, 0x72, 0x74, 0x0, 0x0, 0x0, 0x0, 0x0,
        0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
    ];

    // .text is 16byte align
    if text.len() < 16 {
        for i in 0..16 - text.len() {
            text.push(0x0);
        }
    } else {
        // todo
